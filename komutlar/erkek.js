...
const tag = '⌬'   
const erkekrol = message.guild.roles.cache.find(r => r.id === '800659504379068467') 
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '796111676385918976')
